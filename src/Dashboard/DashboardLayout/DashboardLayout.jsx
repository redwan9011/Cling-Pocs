    ...
    return (
            <div className="grid grid-cols-12 gap-5 h-screen mt-5 mx-5 ">
                ...
                <div className="col-span-3 bg-gray-600 text-white rounded-xl overflow-hidden mb-5 text-center">
                    ...
                    <Link className="flex items-center gap-3" to='/dashboard/admissionTable'><BsBoxSeam /> Dasboard</Link>
                ...
                <div className="col-span-9">
                    <div>
                        ...
                        <div className="flex justify-between">
                            <div>
                                <span className="flex items-center"><IoMdHome ></IoMdHome> / Dasboard</span>
                                <h1>Dashboard</h1>
